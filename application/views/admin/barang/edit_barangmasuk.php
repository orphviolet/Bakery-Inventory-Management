    ...
    <section class="content">
        <div style="margin: 20px auto; width: 60%; background-color: #FDF2E9; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
            <div style="padding: 20px; border-bottom: none;">
                <h3 style="color: #6E3F26; font-weight: bold;">Edit Barang Masuk</h3>
            </div>
                ...
                <form method="POST">
                    <div style="margin-bottom: 20px;">
                        ...
                        <select name="id_roti" class="form_control form_select" style="width: 100%; padding: 10px; border: 1px solid #E5E5E5; border-radius: 5px;">
                            ...
                            <option class="form_control" value="<?php echo $value['id_roti'] ?>" <?php echo $value['id_roti'] == $barang_masuk['id_roti'] ? 'selected' : ''; ?>>
                    ...
                    <div style="margin-bottom: 20px;">
                        <label for="jumlah_masuk" style="color: #6E3F26; display: block; margin-bottom: 5px;">Jumlah Masuk</label>
                        <input type="number" name="jumlah_masuk" class="form_control" value="<?php echo $barang_masuk['jumlah_masuk'] ?>"
                               style="width: 100%; padding: 10px; border: 1px solid #E5E5E5; border-radius: 5px;">
                    </div>
                    <div style="margin-bottom: 20px;">
                        <label for="tanggal_masuk" style="color: #6E3F26; display: block; margin-bottom: 5px;">Tanggal Masuk</label>
                        <input type="date" name="tanggal_masuk" class="form_control" value="<?php echo $barang_masuk['tanggal_masuk'] ?>"
                               style="width: 100%; padding: 10px; border: 1px solid #E5E5E5; border-radius: 5px;">
                    </div>
                    <button type="submit" 
