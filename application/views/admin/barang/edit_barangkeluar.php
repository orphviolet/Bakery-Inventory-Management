    ...
    <section class="content">
        <div style="margin: 20px auto; width: 60%; background-color: #FDF2E9; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
            <div style="padding: 20px; border-bottom: none;">
                <h3 style="color: #6E3F26; font-weight: bold;">Edit Barang Keluar</h3>
            </div>
            <div style="padding: 20px;">
                <form method="POST">
                    <div style="margin-bottom: 20px;">
                        ...
                        <select name="id_roti" class="form_control form_select" style="width: 100%; padding: 10px; border: 1px solid #E5E5E5; border-radius: 5px;">
                            ...
                            <?php foreach ($dataroti as $key => $value): ?>
                                <option value="<?php echo $value['id_roti']; ?>" 
                                    <?php echo ($value['id_roti'] == $barang_keluar['id_roti']) ? 'selected' : ''; ?>>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="number" name="jumlah_keluar" class="form_control" value="<?php echo $barang_keluar['jumlah_keluar']; ?>"
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="date" name="tanggal_keluar" class="form_control" value="<?php echo $barang_keluar['tanggal_keluar']; ?>"
                               style="width: 100%; padding: 10px; border: 1px solid #E5E5E5; border-radius: 5px;">
                    </div>
                    <button type="submit" 
